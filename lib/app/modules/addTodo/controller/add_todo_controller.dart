...
class AddTodoController extends GetxController {
  ...
  void submitData() async {
    ...
    if (isSuccess) {
      AppConstant.showSuccessMessage(message: 'Todo creation successfully', context: Get.context!);
      // Clear field
      ...
      AppConstant.showErrorMessage(message: 'Todo creation failed', context: Get.context!);
    }
  }
